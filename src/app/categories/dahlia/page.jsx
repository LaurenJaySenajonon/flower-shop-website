...
export default function DahliaPage() {
  const products = [
    { 
      id: 1, 
      name: 'Sunset Dahlia Bouquet | Radiant Blooms in Grand', 
      originalPrice: '₱2,600.00 PHP',
      price: '₱2,200.00 PHP', 
              ...
              <div className="relative aspect-square w-full bg-slate-900 rounded-none overflow-hidden border border-white/10 mb-2.5 shadow-md">
                ...
                {product.isSale && (
                  <div className="absolute top-2.5 left-2.5 bg-[#1e1b18]/85 backdrop-blur-md border border-white/10 px-2.5 py-0.5 rounded-none shadow-sm">
                    <span className="font-sans text-[10px] sm:text-[11px] tracking-widest uppercase text-white font-medium">
                      Sale
                    </span>
                  </div>
                )}
