...
export default function CategoryPage() {
  const products = [
    {
      id: 1,
      name: "Stella | Preserved Blooms | Round Blooms in Grand",
      originalPrice: "₱3,300.00 PHP",
      price: "₱2,799.00 PHP",
    ...
    {
      id: 2,
      name: "Laira Mermaid | Dried & Preserved Blooms | Super Mini",
      originalPrice: "₱1,800.00 PHP",
      price: "₱1,399.00 PHP",
      image: "/images/Tulips/1.png",
      isSale: true,
    },
    {
      id: 3,
      name: "Galene Mermaid | Dried & Preserved Blooms | Super Mini",
      originalPrice: "₱1,800.00 PHP",
      price: "₱1,399.00 PHP",
      image: "/images/Tulips/1.png",
      isSale: true,
    ...
    {
      id: 4,
      name: "Gyros in Blue | Preserved Blooms | Petite",
      originalPrice: "₱2,599.00 PHP",
      price: "₱2,299.00 PHP",
      image: "/images/Tulips/1.png",
      isSale: true,
    },
          ...
          {products.map((product) => (
            ...
            >
              ...
              <div className="flex flex-col flex-grow px-0.5">
                <h3 className="font-[family-name:var(--font-cormorant)] text-xs sm:text-sm text-white/90 leading-snug font-normal hover:text-[#f97316] transition-colors duration-300 line-clamp-2">
                  {product.name}
                </h3>
                ...
                <div className="flex items-center gap-1.5 sm:gap-2 mt-auto pt-0.5">
                  <span className="font-sans text-[11px] sm:text-xs text-white/40 line-through">
