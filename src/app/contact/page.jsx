...
export const metadata = {
  ...
  description:"Contact Mon's Craft in Lupon, Davao Oriental to order handcrafted flower arrangements and bouquets for your next celebration.",
  alternates: {
    canonical: "/contact",
  },
  openGraph: {
  ...
  return (
    <main className="mx-auto max-w-6xl px-6 pt-32">
      ...
      <p className="mb-4 text-gray-600">
        Reach out to order handcrafted flower arrangements in Lupon, Davao
        Oriental.
      </p>
      ...
      <div className="space-y-3 text-gray-600">
        ...
        <p>
          <span className="font-semibold text-gray-900">Messenger:</span> Your
          Flower Shop
        </p>
        <p>
        ...
        <p>
          <span className="font-semibold text-gray-900">Hours:</span> Monday –
