...
export default function Hero() {
  return (
    <section className="relative flex min-h-[100svh] w-full flex-col justify-between overflow-x-hidden bg-[#332a23] text-white">
      {/* =====================================================
          BACKGROUND
      ===================================================== */}
      <div className="pointer-events-none absolute inset-0 z-0">
        <Image
          src="/images/BG/2.png"
          alt="MonsCraft handmade and creative collection"
          fill
          priority
          quality={100}
          sizes="100vw"
  ...
  "
      ...
      text-[clamp(2.6rem,13vw,6.5rem)]
      lg:text-[clamp(7rem,12vw,13rem)]
    ...
    `}
        ...
        >
          {/* =================================================
              EXPLORE PRODUCTS
          ================================================= */}
          <Link href="/#ShopByCategory" className="w-auto">
            <span
              className={`
                ${montserrat.className}
                ...
                sm:h-[48px]
                md:h-[52px]
                [@media(max-height:500px)]:h-[30px]
                [@media(max-height:500px)]:px-3
                rounded-lg
                xs:rounded-xl
                sm:rounded-2xl
                border
